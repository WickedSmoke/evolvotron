...
MutatableImageComputerTask*const MutatableImageComputerFarm::pop_todo()
{
  ...
  std::multiset<MutatableImageComputerTask*,CompareTaskPriority>::iterator it=_todo.begin();
  if (it!=_todo.end())
    {
      ret=(*it);
      _todo.erase(it);
...
MutatableImageComputerTask* MutatableImageComputerFarm::pop_done()
{
  ...
  std::multiset<MutatableImageComputerTask*,CompareTaskPriority>::iterator it=_done.begin();
  if (it!=_done.end())
    {
      ret=(*it);
      _done.erase(it);
