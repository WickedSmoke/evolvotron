...
REGISTER_DCL(FunctionFriezeGroupHopCutFreeZ);
...
REGISTER_DCL(FunctionFriezeGroupJumpCutFreeZ);
...
REGISTER_DCL(FunctionFriezeGroupSpinhopCutClampZ);
REGISTER_DCL(FunctionFriezeGroupSpinhopCutFreeZ);
...
void register_all_functions(FunctionRegistry& r)
{
  ...
  register_FunctionFriezeGroupHopCutFreeZ(r);
  ...
  register_FunctionFriezeGroupJumpCutFreeZ(r);
  ...
  register_FunctionFriezeGroupSpinhopCutClampZ(r);
  register_FunctionFriezeGroupSpinhopCutFreeZ(r);
