...
/*! \file 
  \brief Interfaces for FunctionPreTransform 
  This class would normally live in function.h (and is included there), but is split out so it can be efficiently used by MutatableImageDisplay.
